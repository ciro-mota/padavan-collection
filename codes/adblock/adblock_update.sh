...
wget -qO- "https://block.energized.pro/spark/formats/hosts.txt" | awk -vr="$ENDPOINT_IP4" '{sub(/^0.0.0.0/, r)} $0 ~ "^"r' >> "$TMPDIR"
wget -qO- "https://block.energized.pro/spark/formats/hosts-ipv6.txt" | awk -vr="$ENDPOINT_IP6" '{sub(/^::/, r)} $0 ~ "^"r' >> "$TMPDIR"
